...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Agu 2020 pada 02.10
...
INSERT INTO `barang_masuk` (`id_barang_masuk`, `id_barang`, `id_supplier`, `jumlah_masuk`, `waktu_masuk`) VALUES
(2, 1, 1, 11, '2020-08-07'),
(3, 2, 7, 551, '2020-08-19');
...
INSERT INTO `kategori` (`id_kategori`, `id_satuan`, `nama_kategori`) VALUES
(4, 6, 'material'),
(5, 6, 'bahan baku');
